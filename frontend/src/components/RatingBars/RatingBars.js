...
const RatingBars = ({ reviews }) => {
    ...
    reviews.forEach((review) => {
        avgCleanliness += review.cleanliness / reviews.length
        avgAccuracy += review.accuracy / reviews.length
        avgCommunication += review.communication / reviews.length
        avgLocation += review.location / reviews.length
        avgCheckin += review.checkin / reviews.length
        avgValue += review.value / reviews.length
    })
